...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode NEW_NODE = l.newNode(item, l, this,this.next);
    this.next = NEW_NODE;
    this.next.next.prev = NEW_NODE;
    l.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DList l = (DList)this.myList;
    DListNode NEW_NODE = l.newNode(item, l, this.prev,this);
    this.prev= NEW_NODE;
    this.prev.prev.next = NEW_NODE;
    l.size++;
  }
