...
public class Sobel {
  ...
  private static void sobelFile(String filename, int numIterations,
                                boolean rle) {
    System.out.println("Reading image file /Users/Wind_Knight/eclipse-workspace/pj1/pic/" + filename);
    PixImage image = ImageUtils.readTIFFPix("/Users/Wind_Knight/eclipse-workspace/pj1/pic/"+filename);
    ...
    if (numIterations > 0) {
      ...
      System.out.println("Writing blurred image file /Users/Wind_Knight/eclipse-workspace/pj1/pic/" + blurname);
      TIFFEncoder.writeTIFF(blurred, "/Users/Wind_Knight/eclipse-workspace/pj1/pic/"+blurname);
    }
    ...
    System.out.println("Writing grayscale-edge image file /Users/Wind_Knight/eclipse-workspace/pj1/pic/" + edgename);
    TIFFEncoder.writeTIFF(sobeled, "/Users/Wind_Knight/eclipse-workspace/pj1/pic/"+edgename);
    if (rle) {
