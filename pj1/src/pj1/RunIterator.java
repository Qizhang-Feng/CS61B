...
public class RunIterator implements Iterator {
  ...
  public void addPrev(Run r) {
	  if(iterator.prev != null) {
		  r.next = iterator;
		  r.prev = iterator.prev;
		  iterator.prev.next = r;
		  iterator.prev = r;
	  }
	  else {
		  r.next = iterator;
  ...
  public void changeRGBL(int r,int g,int b,int l) {
	  iterator.RGBL[0] = r;
	  iterator.RGBL[1] = g;
	  iterator.RGBL[2] = b;
	  iterator.RGBL[3] = l;
  ...
  public String toString() {
	  String str;
	  str = "("+iterator.RGBL[0]+","+iterator.RGBL[1]+","+iterator.RGBL[2]+","+iterator.RGBL[3]+")";
	  return str;
  }
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
	  ...
	  if(this.hasNext()) {
		  ...
		  System.out.println("This is the last Run!");
	  }
	  return rgbl;
  }
  ...
  public int[] nextColor() {
	  if(this.hasNext()) {
		  ...
		  nextColor[0] = iterator.next.RGBL[0];
		  nextColor[1] = iterator.next.RGBL[1];
		  nextColor[2] = iterator.next.RGBL[2];
		  return nextColor;
	  }
	  else {
		  System.out.println("This is the last Run!");
  ...
  public int nextLength() {
	  if(this.hasNext()) {
		  int nextLength = iterator.next.RGBL[3];
		  return nextLength;
	  }
	  else {
		  System.out.println("This is the last Run!");
		  return iterator.RGBL[3];
	  } 
  }
  ...
  public int[] Color() {
	  int[]	nowColor = new int[3];
	  nowColor[0] = iterator.RGBL[0];
	  nowColor[1] = iterator.RGBL[1];
	  nowColor[2] = iterator.RGBL[2];
	  return nowColor;
  }
